        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col gap-6">
              {/* Title and Price */}
              <div>
                <h1 className="text-3xl md:text-4xl font-normal text-foreground mb-4 uppercase">
                  {product.name}
                </h1>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 w-fit">
                  <button
                    ...
                    className="px-3 py-2 border border-border hover:border-foreground"
                  >
                    −
                  </button>
                  <input
                    ...
                    className="w-12 py-2 text-center border border-border bg-background focus:outline-none focus:border-foreground"
                    min="1"
                  />
                  <button
              ...
              <div className="flex flex-col gap-3">
                <Button
                  ...
                  className="w-full py-3 text-base font-semibold rounded-none"
                >
                  ADD TO CART
                </Button>
              ...
              <div className="border-t border-border pt-6 space-y-3">
                <p className="text-sm text-muted-foreground">
                  <span className="font-semibold text-foreground">Custom {product.name}</span>
                </p>
              ...
              <div className="border-t border-border pt-6 space-y-2">
                <p className="font-semibold text-foreground">Fabric info:</p>
              ...
              <div className="border-t border-border pt-6">
                ...
                <div className="flex gap-3">
                  <button className="p-2 border border-border hover:border-foreground">
                    <Facebook size={18} />
                  </button>
                  <button className="p-2 border border-border hover:border-foreground">
                    <Twitter size={18} />
